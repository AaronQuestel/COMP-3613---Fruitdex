        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              ...
              <NavItem title="Regional Fruitdex" link={Routes.DashboardOverview.path} icon={faChartPie} />
              <NavItem external title="Pending Approval" link="https://demo.themesberg.com/volt-pro-react/#/messages" target="_blank" icon={faInbox} />
              {/* <NavItem title="Transactions" icon={faHandHoldingUsd} link={Routes.Transactions.path} /> */}
              <NavItem external title="Map" link="https://demo.themesberg.com/volt-pro-react/#/map" target="_blank"  icon={faMapPin} />
